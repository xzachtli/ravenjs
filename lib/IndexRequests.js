...
IndexRequests.prototype.raw = function(index) {
	var self = this;
	self.indexDef = index;
	return this;
};
...
IndexRequests.prototype.create = function(callback) {
	...
	if (!_(self.indexDef.map).isString() && !_(self.indexDef.Map).isString()) throw new Error('Expected at least map expression. Use map() function to define a map.');
