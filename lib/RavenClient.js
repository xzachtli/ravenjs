...
RavenClient.prototype.get = function(id, includes, callback) {
	var self = this;
	var request = new DocumentRequests(self.settings);
	return request.get(id, includes, callback);
};
...
RavenClient.prototype.deleteByIndex = function(indexName, callback) {
	var self = this;
	var request = new DocumentRequests(self.settings);
	return request.deleteByIndex(indexName, callback);
};